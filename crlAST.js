...
// ID: crlastgen
// Description: Generates the AST For CRL for Constellinux / The Constellinux Project
  ...
  class crlastgen {
    getInfo() {
      return {
        ...
        blocks: [
          {
            opcode: "blockGenerateAST",
            blockType: Scratch.BlockType.REPORTER,
            text: "generate AST for code: [CODE]",
            arguments: {
                CODE: {
          ...
          {
            opcode: "blockreTokenise",
            blockType: Scratch.BlockType.REPORTER,
            text: "reTokenise [CODE]",
            arguments: {
                CODE: {
                  type: Scratch.ArgumentType.STRING,
                  defaultValue: "",
    ...
    blockGenerateAST(args) {
        return generateAST(args.CODE)
    }

    blockreTokenise(args) {
        return reTokenise(args.CODE)
    }
  }

  Scratch.extensions.register(new crlastgen());
})(Scratch);